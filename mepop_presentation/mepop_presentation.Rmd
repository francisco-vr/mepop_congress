...
knitr::include_graphics("mepop_presentation_files/lab-logo-removebg-preview.png")
```
...
<div style="text-align: justify">
  ...
  - OLS robusto and Maximum likelihood para variables balanceadas y no balanceadas.
...
- Investigaciones futuras: diferencias emocionales opr género, y consideración de oleadas etáreas y comportamiento político
