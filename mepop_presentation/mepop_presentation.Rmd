...
- Redes de amistad y recursos hechas entre personas de pensamiento político similar. Incluye homofilia política, identidad social y sesgos de confirmaciónd. (Boutyline et.al, 2017; Wollebæk et. al, 2019). A menudo producida por algoritmos (Pariser, 2011)
...
## Revisión literatura de intolerancia, emociones cuando se habla con personas del pensamiento opuesto
...
## Relación entre cámaras de eco y ciudadanía digital con intolerancia política y emociones
...
Caracterización sociodemográfica: Rango etario, géner, ingreso, nivel educativo, Ideología política ("Izquierda", "Derecha", "Centro", "Sin ideología") + 2 Estudios experimentales
...
- Se Aplicará un ATE, test de Kruskall Wallis y Wilcoxon para diferencia entre medioas
